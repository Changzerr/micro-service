package com.changzer.pinda.user.config;

import java.util.List;

import com.changzer.pinda.user.interceptor.ContextHandlerInterceptor;
import com.changzer.pinda.user.feign.UserResolveApi;
import com.changzer.pinda.user.interceptor.ContextHandlerInterceptor;
import com.changzer.pinda.user.resolver.ContextArgumentResolver;
